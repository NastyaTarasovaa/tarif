...
const tarifs = [
  ...
  {name: "Безлимитный 550", price: "550 руб./мес", speed: "до 100 Мбит/сек", text: "Объем включенного трафика не ограничен",priceColor: "rgba(244,106,95,255)", nameColor: "rgba(196,85,78,255)", isSelected:true },
...
class App extends React.Component {
  ...
  return (
    <div className="App">
      {
        tarifs.map((tarif)=>
        <Tarif name={tarif.name} price={tarif.price} speed={tarif.speed} text={tarif.text} priceColor={tarif.priceColor} nameColor={tarif.nameColor} isSelected={tarif.isSelected} ></Tarif>
        )
      }
